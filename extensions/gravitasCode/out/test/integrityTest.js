...
const integrity_1 = require("../uiv2/integrity");
/**
...
function testIntegrity() {
    ...
    const result1 = (0, integrity_1.verifyContentIntegrity)(content);
    ...
    const result2 = (0, integrity_1.verifyContentIntegrity)(contentWithHash);
    ...
    const result3 = (0, integrity_1.verifyContentIntegrity)(grownContent);
    ...
    const result4 = (0, integrity_1.verifyContentIntegrity)(tamperedContent);
...
testIntegrity();
//# sourceMappingURL=integrityTest.js.map